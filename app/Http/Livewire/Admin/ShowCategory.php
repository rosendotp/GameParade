...
class ShowCategory extends Component
{
    ...
    protected $rules = [
        ...
        'createForm.platform' => 'required',
        'createForm.edition' => 'required',
    ];
    ...
    public function edit(Subcategory $subcategory){
        ...
        $this->editForm['platform'] = $subcategory->platform;
        $this->editForm['edition'] = $subcategory->edition;
    ...
    public function update(){
        $this->validate([
            ...
            'editForm.platform' => 'required',
            'editForm.edition' => 'required',
        ]);
