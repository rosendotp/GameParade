<x-guest-layout>
    <x-authentication-card>
        <div class="flex items-center justify-center mb-1">
            <svg xmlns="http://www.w3.org/2000/svg" version="1.0" width="250.000000pt" height="250.000000pt" viewBox="0 0 425.000000 432.000000" preserveAspectRatio="xMidYMid meet">
        ...
        <a class="underline text-sm text-gray-600 dark:text-gray-400 hover:text-blue-900 dark:hover:text-gray-100 rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 dark:focus:ring-offset-gray-800" href="{{ route('register') }}">
            {{ __('Register') }}
        </a>
    </x-authentication-card>
</x-guest-layout>
